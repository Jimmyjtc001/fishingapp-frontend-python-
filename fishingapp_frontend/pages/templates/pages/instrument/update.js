...
function onPageLoadRunGetInstrumentDetailsFromAPI(instrument_id) {
    ...
    const detailURL = "{{ BACKEND_API_SERVER_ADDRESS }}/api/instrument/"+instrument_id.toString();
...
function onSubmitClick() {
    ...
    xhttp.open("PUT", "{{ BACKEND_API_SERVER_ADDRESS }}/api/instrument/"+instrumentId+"/update", true);
