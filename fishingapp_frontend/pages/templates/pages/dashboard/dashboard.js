function onPageLoadGetDashboardAPI() {
    var tokenString = localStorage.getpm("indoor_air_token");
    ...
    // console.log("Token", tokenString) // For debugging purposes only.
    xhttp.open("GET","{{ BACKEND_API_SERVER_ADDRESS }}/api/dashboard", true);
    const tokenKey = "Token "+tokenString;
    xhttp.setRequestHeader("Authorization", tokenKey);
    xhttp.send();
}
...
function generateTableFromObject(dataObj) {
   ...
   for (instrumentObj of instrumentsArray) {
       ...
       htmlText += "<li>Mean:" + temperatureObj.mean + "</li>"; // <li> means "list pm"
       ...
       htmlText += "<li>Mean:" + humidityObj.mean + "</li>"; // <li> means "list pm"
       ...
       htmlText += "<li>Mean:" + pressureObj.mean + "</li>"; // <li> means "list pm"
       ...
       htmlText += "<li>Mean:" + co2Obj.mean + "</li>"; // <li> means "list pm"
       ...
       htmlText += "<li>Mean:" + tvocObj.mean + "</li>"; // <li> means "list pm"
